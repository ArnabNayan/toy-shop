...
//                }
//                <div className="stats bg-transparent flex flex-col lg:flex-row mt-10 gap-3">
  
//                <div className="stat bg-rose-500 rounded-2xl lg:w-48">
...
//                <div className="stat bg-amber-500 rounded-2xl lg:w-48">
//                  <div className="stat-figure text-white">
...
//                <div className="stat bg-violet-600 rounded-2xl lg:w-48">
...
//              </div>
//              <div className="stat bg-cyan-500 rounded-2xl lg:w-48">
//                  <div className="stat-figure text-white">
    ...
    <div>
      {user?.displayName && (
        <h3 className="text-lg lg:text-3xl font-serif font-semibold">
          Hi, Welcome <span className="text-lg lg:text-3xl font-serif font-semibold text-teal-600">{user.displayName}</span>
        </h3>
      )}
