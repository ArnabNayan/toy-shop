  ...
  const handleClick = () => {
    ...
    >
        ...
        <SwiperSlide>
            ...
            <div 
                className="bg-cover backdrop-brightness-20 bg-center h-64 lg:h-screen w-full relative z-10"
                style={{
                    backgroundImage:
            ...
            <div className="w-full h-full items-center left-0  top-0 bg-gradient-to-r from-[black] to-[gray) 100%">
               ...
               {/* <Link to="/about">
                         ...
                         <button
                                onClick={handleClick}
                                className="btn bg-cyan-600 font-serif font-bold text-sm px-2 lg:px-4 lg:text-xl text-white"
                            >
                                Visit us
                            </button>
               </div>
